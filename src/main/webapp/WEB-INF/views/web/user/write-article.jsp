...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-plus-square-dotted"></i> Viết bài mới</h2>
        <div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/save-article"
                  method="post"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="shortDescription" rows="3" class="form-control" required></textarea>
                </div>
